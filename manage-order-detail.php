                            ...
                            <div class="col-6">
                                <div>
                                    ...
                                    <ul class="list-unstyled m-t-10">
                                        <li class="m-b-5">
                                            <span class="font-strong">A:</span> Nhóm 7-Trường Đại học Phenikaa</li>
                                        <li class="m-b-5">
                                            <span class="font-strong">W:</span> ignoreshop@gmail.com</li>
                                        <li>
                                            <span class="font-strong">P:</span> 0123456789</li>
                                    </ul>
                                </div>
                            </div>
